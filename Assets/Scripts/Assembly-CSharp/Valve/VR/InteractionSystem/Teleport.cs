...
namespace Valve.VR.InteractionSystem
{
	public class Teleport : MonoBehaviour
	{
		...
		private void UpdatePointer()
		{
			...
			teleportArc.SetArcData(position, velocity, true, flag2);
			RaycastHit hitInfo;
		...
		private void FixedUpdate()
		{
			...
			if (teleportArea != null && floorFixupMaximumTraceDistance > 0f)
			{
				...
				down.x = 0.01f;
				RaycastHit hitInfo;
				if (Physics.Raycast(pointedAtPosition + 0.05f * down, down, out hitInfo, floorFixupMaximumTraceDistance, floorFixupTraceLayerMask))
				{
		...
		private void TeleportPlayer()
		{
			...
			RaycastHit hitInfo;
			if (teleportArea != null && floorFixupMaximumTraceDistance > 0f && Physics.Raycast(vector + 0.05f * Vector3.down, Vector3.down, out hitInfo, floorFixupMaximumTraceDistance, floorFixupTraceLayerMask))
			{
